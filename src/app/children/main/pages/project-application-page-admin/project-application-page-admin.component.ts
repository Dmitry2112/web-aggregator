...
@Component({
    ...
    templateUrl: './project-application-page-admin.component.html',
    styleUrls: ['./styles/project-application-page-admin.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    standalone: true,
    imports: [RouterLink, TuiButtonModule]
})
export class ProjectApplicationPageAdminComponent implements OnInit {
